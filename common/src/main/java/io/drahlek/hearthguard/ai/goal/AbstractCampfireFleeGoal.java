...
public abstract class AbstractCampfireFleeGoal<T extends Mob> extends Goal {
    ...
    protected void log(String msg) {
        ResourceLocation typeId = BuiltInRegistries.ENTITY_TYPE.getKey(this.mob.getType());
    ...
    private void dropItem() {
        ...
        LootTable lootTable = serverLevel.getServer().reloadableRegistries().getLootTable(this.mob.getLootTable());
