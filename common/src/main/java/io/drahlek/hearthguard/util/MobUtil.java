...
public final class MobUtil {
    ...
    public static Map<String, List<EntityType<?>>> getMobsByMod() {
    ...
    public static List<String> getMonsterMobIds() {
    ...
    private static List<EntityType<?>> getConfigurableMonsterTypes() {
